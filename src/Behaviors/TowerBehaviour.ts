...
import { BehaviorName, objects, Tag, ElementType, ElementColor, ElementMaterial as ElementMaterial, IN_GAME_SECOND, TimerMode, TowerAttributesType, TowerAbilitiesType } from "../Global";
